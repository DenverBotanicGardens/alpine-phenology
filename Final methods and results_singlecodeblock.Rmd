...
write.table(yr.1950_2, file = "Q:/Research/Projects/alpine-phenology/phensum_yr_388.csv", sep=",")

nrow(yr.1950_2[yr.1950_2$p.value>=0.05,]) #343
nrow(yr.1950_2[yr.1950_2$p.value<0.05,]) #45

nrow(yr.1950_2[yr.1950_2$p.value<0.05,])/nrow(yr.1950_2) #0.1159794
...
nrow(high.1950_2) #388
write.table(high.1950_2, file = "Q:/Research/Projects/alpine-phenology/phen_summary_high_2_388.csv", sep=",")

nrow(high.1950_2[high.1950_2$p.value<0.05,]) #81
nrow(high.1950_2[high.1950_2$p.value<0.05,])/nrow(high.1950_2) #0.2087629
...
write.table(low.1950_2, file = "Q:/Research/Projects/alpine-phenology/phen_sum_low_2_388.csv", sep=",")

nrow(low.1950_2[low.1950_2$p.value<0.05,]) #73
nrow(low.1950_2[low.1950_2$p.value<0.05,])/nrow(low.1950_2) #0.1881443
...
write.table(precip.1950_2, file = "Q:/Research/Projects/alpine-phenology/phen_sum_precip_2_388.csv", sep=",")

nrow(precip.1950_2[precip.1950_2$p.value<0.05,]) #37
nrow(precip.1950_2[precip.1950_2$p.value<0.05,])/nrow(precip.1950_2) # 0.09536082
mean(precip.1950_2$Slope) #0.02090737
