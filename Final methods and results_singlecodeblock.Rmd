...
earcol[which.max(earcol$Collections),] # 1998 270
mean(earcol$Collections) #165.4262 -> 97.27
...
##What about the bloom.sp, what's in there
#head(bloom.sp)
#n_dups <- aggregate(ID~Year+elevation+Decimal.Latitude+Decimal.Longitude+scientificName,
#                    function(x) length(x), data = bloom.sp)


#n_dups[n_dups$ID>1,]

#bloom.sp[bloom.sp$scientificName=="Achillea millefolium"&bloom.sp$elevation==3460,]
