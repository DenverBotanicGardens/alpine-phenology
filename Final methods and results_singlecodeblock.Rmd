...
###START HERE, figure out how many years each species has data for, not sum how many times
...
### Need ones that are these IDs from only 1981.. maybe minNPNGDDmax.all... oh, same as before but want from all... don't think I needed all that, just need that list of IDs from merge.name.accpt.ALL
