...
#Figure 4D 
```{r}
min1950GDDsecant2 <- merge(min1950GDD_2, secant.poly.all,by="Year")
...
###START HERE
# Zigadenus elegans is in twice and both don’t have numbers for precip, or high, one for low, both for year
