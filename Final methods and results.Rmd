...
### Start here!! check that min date is only selecting one record for earliest collection date!!!
### AAAHHH, there shouldn't be 2 anywhere! Why are there two in a year!??!?!?
table(npn.min1950$scientificName,npn.min1950$Year)
```
...
#earlier
nrow(rst[rst$p.value<0.05 & rst$Slope < 0,]) #8
