...
#Check for synonyms   
```{r}
synonyms <- read.csv(text = getURL("https://raw.githubusercontent.com/DenverBotanicGardens/alpine-phenology/master/datasets/synonym_list_ALL_2.txt"))
...
badnames <- setdiff(namebloom2,bloom2$scientificName)
badnames[1:100]
length(badnames) #471
...
corrections <- read.csv(text = getURL("https://raw.githubusercontent.com/DenverBotanicGardens/alpine-phenology/master/datasets/synonym_list_ALL.txt"))
