...
merge.name$Growth.Habit[merge.name$scientificName == "Artemisia campestris var. borealis"] <- "Forb/herb"
merge.name$Family[merge.name$scientificName == "Artemisia campestris var. borealis"] <- "Asteraceae"
merge.name$Duration[merge.name$scientificName == "Artemisia campestris var. borealis"] <- "Biennial, Perennial"
