...
length(unique(bloom2$scientificName)) #2299 -> 1835 -> 1938 -> 1820
length(unique(bloom2$ID)) # 1563 grouped by synonyms -> 1583 -> 1517
...
#JUST make a list that links the ID to the accepted name to link that in the tables produced!!
...
############# or
rm(linknames)
linknames <- merge(unique(bloom2[,c("scientificName","Family.Name","ID")]),
                   plantsyn[plantsyn$Synonym.Symbol=="",c(1:4,25:31)],
