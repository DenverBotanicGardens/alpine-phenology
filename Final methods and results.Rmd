...
spyears[which.max(spyears$DataYrs),]
nrow(spyears[spyears$DataYrs>=10,])
mean(spyears$DataYrs[spyears$DataYrs>=10])

spyears$Species <- row.names(spyears)
sp.10plus <- spyears[spyears$DataYrs>=10,]
nrow(sp.10plus) #547 -> 545, after changing all spelling to coerulea from caerulea and Eritrichum to Eritrichium
```
...
length(unique(tenyearplus$scientificName)) #545
...
nrow(min1950_2[min1950_2$Year > 1980,]) # 7737 -> 7732
...
length(unique(min1950GDD_2$scientificName)) #545
...
length(unique(min1950GDD_2_10$scientificName)) #545
