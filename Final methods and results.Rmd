...
nrow(low.NPN_2[low.NPN_2$p.value<0.05,]) #103

#earlier
nrow(low.NPN_2[low.NPN_2$p.value<0.05 & low.NPN_2$Slope<0,]) #97
...
#later
nrow(precip.NPN_2[precip.NPN_2$p.value<0.05 & precip.NPN_2$Slope>=0,]) #6
