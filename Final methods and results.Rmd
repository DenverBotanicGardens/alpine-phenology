...
bloom2[grep("Boechera",bloom2$scientificName),]
bloom2[grep("Arabis",bloom2$scientificName),]
...
length(unique(bloom2$scientificName)) #2297
...
length(spyears[spyears$DataYrs>=10,])
...
length(unique(min1950GDD_2_10$scientificName)) #545 -> 406
