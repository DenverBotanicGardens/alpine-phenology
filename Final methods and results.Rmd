...
length(grep("ssp.", plantsyn$Subspecies.Prefix)) #1456
length(grep("subsp.", plantsyn$Subspecies.Prefix)) #0

length(unique(plantsyn$Scientific.Name)) #15353
length(unique(plantsyn$Accepted.Symbol)) #5513
length(unique(plantsyn$Synonym.Symbol)) #9883
