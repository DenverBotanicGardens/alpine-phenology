...
#Fresh start
```{r, eval=FALSE}
rm(accpt, acpted, allcol, allcollections, alltable, blnew, 
   bloom, bloom.o, bloom2, bloomfoo,
   collJ.sp, collJ.max, collmax, colo, colo.bind, colo.sm, colpyear, colpyear.2, 
   col.hdd.yrs, dat, demo1, earcol,
   earliestcollection, fams, fixbloom2, fixbloom2.all, foo, foo12, foo3, foo4, 
   foo5, GD, GDD.1981, gdd.bl,
   gdd.sig, gdd.sig.min, gdddatayrs, GH, gtyr, hdd.bl, hdd.f, hdd.foo, HDD.npn, 
   HDD.0, HDD.0.all, 
   HDD.npn.sig, hdd.snow, high.1950, high.npn_2, high.1950_2, linknames, lo.npn, 
   lo.npn.Jul, low.1950,
   low.1950_2, m15, m9, max.swe, Maxpyr, merge.name, min.dates, min.dates.snow, 
   min1950_2,
...
```
#         ID                            SYNONYMS
25940 14110                 Dasiphora fruticosa
25942 14111 Dasiphora fruticosa ssp. floribunda
25944 14111                 Dasiphora fruticosa
                                                                AUTH
25940                                 Dasiphora fruticosa (L.) Rydb.
25942 Dasiphora fruticosa (L.) Rydb. ssp. floribunda (Pursh) Kartesz
25944                       Dasiphora fruticosa auct. non (L.) Rydb.
synonyms[grep("Noccaea fendleri", synonyms$SYNONYMS),] #ID = 30635
...
merge.name$scientificName[merge.name$scientificName == "Dasiphora floribunda"] <- "Dasiphora fruticosa"
merge.name$Growth.Habit[merge.name$scientificName == "Dasiphora fruticosa"] <- "Shrub"
merge.name$Family[merge.name$scientificName == "Dasiphora fruticosa"] <- "Rosaceae"
merge.name$Duration[merge.name$scientificName == "Dasiphora fruticosa"] <- "Perennial"
...
sort(table(yr.1950_2$Species)) #Still two Dasiphora fruticosa!!!
