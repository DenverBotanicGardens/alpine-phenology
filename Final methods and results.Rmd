...
# ID links synonyms
bloom2 <- merge(bloom2, synonyms[,-3], by.x = "scientificName", by.y = "SYNONYMS")

length(unique(synonyms$SYNONYMS)) #91,084 names
length(unique(synonyms$ID)) #48,141 unique taxa
length(unique(bloom2$scientificName)) #2299 different names in bloom2 before merge - then 1986 after
