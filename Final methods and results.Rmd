...
merge.name[grep(paste(unique(singlefoo$Var2[singlefoo$Freq>1]),
                      collapse="|"),merge.name$ID),]
...
#Need to get rid of the second half
removerows.41494 <- c(which(merge.name$ID== 41494))[12:22] #11 long
removerows.43988 <- c(which(merge.name$ID == 43988))[16:30] #15
