...
fixbloom2.all <- fixbloom2[complete.cases(fixbloom2),]

bloomfoo <- bloom2
matches <- match(bloomfoo$scientificName,fixbloom2.all$Wrong)

bloomfoo$scientificName[matches[complete.cases(matches)]] <-
  fixbloom2$Replacement[matches[complete.cases(matches)]]
