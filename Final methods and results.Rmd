...
accpt <- rbind(accpt,c("Aster foliaceus","43988","","",
                       "","Perennial","Forb/herb","AK (N), CAN (N), L48 (N)",
                       "","",""))
accpt <- rbind(accpt,c("Carex atrata","8105","","",
                       "","Perennial","Graminoid","GL (N)",
                       "","",""))
accpt <- rbind(accpt,c("Carex micropoda","8591","","",
                       "","Perennial","Graminoid","AK (N), CAN (N), L48 (N)",
                       "","",""))
accpt <- rbind(accpt,c("Hieracium triste var. triste","22207","","",
                       "","Perennial","Forb/herb","AK (N), CAN (N)",
                       "","",""))
accpt <- rbind(accpt,c("Eutrema edwardsii","18851","","",
                       "","Perennial","Forb/herb","AK (N), CAN (N), GL (N)",
                       "","",""))
accpt <- rbind(accpt,c("Hieracium triste","22205","","",
                       "","Perennial","Forb/herb","AK (N), CAN (N), L48 (N)",
                       "","",""))
accpt <- rbind(accpt,c("Ligularia bigelovii","41494","","",
                       "","Perennial","Forb/herb","L48 (N)",
                       "","",""))
accpt <- rbind(accpt,c("Poa nervosa","35582","","",
                       "","Perennial","Graminoid","CAN (N), L48 (N)",
                       "","",""))
accpt <- rbind(accpt,c("Salix arctica","39918","","",
                       "","Perennial","Shrub, Subshrub","AK (N), CAN (N), GL (N), L48 (N)",
                       "","",""))
...
accpt <- rbind(accpt,c("Valeriana capitata","46589","","",
                       "VECA2","Perennial","Forb/herb","AK (N), CAN (N)",
                       "","",""))
accpt <- rbind(accpt,c("Veratrum californicum","46683","","",
                       "VECA2","Perennial","Forb/herb","L48 (N)",
                       "","",""))
...
merge.name[merge.name$ID == 41494,] #just repeated for the synonym. 
merge.name[merge.name$ID == 43988,] #just repeated for the synonym. 

removerows.41494 <- c(which(merge.name$ID == 41494 & merge.name$scientificName == "Ligularia bigelovii"))
removerows.43988 <- c(which(merge.name$ID == 43988 & merge.name$scientificName == "Aster foliaceus"))
...
length(unique(merge.name$ID)) #487
mean(merge.name$DataYrs[!duplicated(merge.name$ID)]) # 23.66324 years

nrow(merge.name) #11415
...
table(unique(merge.name$Growth.Habit))
...
merge.name$scientificName[is.null(merge.name$Growth.Habit)&!is.na(merge.name$ID)]
