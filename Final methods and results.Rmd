...
```{r}
nrow(merge.name[merge.name$Year > 1980,]) #7295
...
length(unique(min1950GDD_2$day)) #1152 -> 1145
length(unique(min1950GDD_2$scientificName)) #486
