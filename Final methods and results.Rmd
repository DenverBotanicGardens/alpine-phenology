...
intersect(badnames.o, synonyms2$SYNONYMS)
...
[1] "Aster foliaceus"                   "Carex maritima" (only 9 years data!)"Castilleja rhexifolia"            
...
accpt <- data.frame()
accpt <- rbind(accpt, c("Aster foliaceus","Symphyotrichum foliaceum"))
names(accpt) <- c("Syn","Accpt")
accpt <- rbind(accpt, c("Carex maritima","Symphyotrichum foliaceum"))
