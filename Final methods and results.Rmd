...
### NEED TO DO THE synonym changes first!
...
nrow(sp.yr[sp.yr$Freq>0,]) #14369 -> 14840
...
mean(spyears$DataYrs[spyears$DataYrs>=10]) #23.7102
...
length(unique(tenyearplus$scientificName)) #654 -> 734
...
head(min1950_2.foo)
length(unique(min1950_2.foo$ID)) #498! Yay! -> 473, but what does that mean for missing names? 488
...
min1950_2[min1950_2$Growth.Habit == "" & !is.na(min1950_2$scientificName),]
table(unique(min1950_2$Growth.Habit))
sum(table(unique(min1950_2$scientificName)))
