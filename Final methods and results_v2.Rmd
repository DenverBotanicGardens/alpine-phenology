...
mean(species.per.year.10$SpeciesTotal) # 185.2623
...
yr.1950_2[grep("Agoseris", yr.1950_2$Species),]
...
nrow(yr.1950_2[yr.1950_2$Species %in% checksame$Species,]) # 1 -> 404
...
unique(merge.name.accpt$SYNONYMS[which(merge.name.accpt$ID %in% 
