...
### Want to see how many of these species IDs from bloom2 are in synonyms.plantsyn
missingfrom480 <- setdiff(yr.1950_2$ID,accptIds)
length(missingfrom480)
unique(merge.name$scientificName[merge.name$ID %in% missingfrom480])



missingfromALL <- setdiff(unique(sp.10plus$ID), unique(synonyms.plantsyn$ID))
length(missingfromALL)
