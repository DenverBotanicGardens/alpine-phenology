...
### START HERE --- move this after the table making begins!
### DON't need this until making the final tables...
...
str(collJ.sp)
collJ.sp[,1:3] <- sapply(collJ.sp[,1:3], function(x){
  as.numeric()
})

coll.per.julianday <- aggregate(collJ.sp, list(collJ.sp$Var2), sum)
