...
write.table(unique(bloom2),
            file="P:/hackathon/alpine-phenology/datasets/bloom2_170125.csv", sep=",")
...
# Names missing 
"Antennaria parvifolia"             "Carex atrata"        "Carex micropoda"     "Eritrichium aretioides"     
...
#synonyms$ID[synonyms$SYNONYMS=="Eritrichium nanum var. aretioides"]<-
...
#how many species in dataset
length(unique(bloom2$scientificName)) #1820 -> 1588, 1703, 1918 -> 1916
length(unique(bloom2$ID)) #1516 -> 1319, 1371, 1563 
