...
mean(species.per.year.10$SpeciesTotal) # 185.5246
...
mean(earcol$Collections) #168.4098 -> 185.5246
...
#overall average
mean(sp.10plus$startDayOfYear) #200.663
...
```{r}
mean(earcol$Collections) # 185.5246
```
...
length(unique(min1950GDD_2$day)) #1130
length(unique(min1950GDD_2$scientificName)) #639
length(unique(min1950GDD_2$ID)) #470
...
nrow(yrspsp[yrspsp$x>=10,]) #308 -> 375 -> 368
...
length(unique(min1950GDD_2_10$ID)) #375 -> 368
...
nrow(yr.1950_2[yr.1950_2$p.value>=0.05,]) #413
nrow(yr.1950_2[yr.1950_2$p.value<0.05,]) #57

nrow(yr.1950_2[yr.1950_2$p.value<0.05,])/nrow(yr.1950_2) #0.1212766
...
unique(merge.name$ID[merge.name$scientificName %in% grep(paste(
...
nrow(yr.1950_2[yr.1950_2$Species %in% checksame$Species,]) # 399
...
mean(high.1950_2$Slope[high.1950_2$p.value<0.05 & high.1950_2$Slope<0]) # -10.80244
mean(high.1950_2$adj.r.squ[high.1950_2$p.value<0.05 & high.1950_2$Slope<0]) #0.2381122
