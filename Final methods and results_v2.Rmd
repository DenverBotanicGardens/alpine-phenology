...
missingIDs[1] # Carex atrata L. non should be Carex heteroneura
synonyms[synonyms$ID == missingIDs[1],]
synonyms[synonyms$SYNONYMS == "Carex heteroneura",]
...
plantsyn$Scientific.Name[grep("Veratrum tenuipetalum", plantsyn$Scientific.Name)] <- "Veratrum californicum"
