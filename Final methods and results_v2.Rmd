...
length(unique(bloom2$ID)) #1516 -> 1319, 1371, 1563 (1562)
...
spyears[which.max(spyears$DataYrs),] # 51
spyears[which.min(spyears$DataYrs),] # 1
nrow(spyears[spyears$DataYrs>=10,]) #414 -> 402 -> 300, 346 -> 468 -> 480 -> 472 -> 471
mean(spyears$DataYrs[spyears$DataYrs>=10]) #24.07219

# Now 10 plus years
sp.10plus <- earl.sp.yr[earl.sp.yr$DataYrs>=10,]
length(unique(sp.10plus$ID)) #414 -> 402 -> 300, 480 -> 473 -> 471
...
#[1] "Carex atrata"  =8105 fixed    "Carex pyrenaica"  =8590 (not in list anymore)  
#    "Carex pyrenaica ssp. pyrenaica" =8592
