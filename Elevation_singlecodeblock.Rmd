...
table(merge.name.accpt_cc$Decimal.Latitude[merge.name.accpt_cc$Decimal.Latitude==39]) #74 are center of colorado probably - 39. Those should be removed
merge.name.accpt_cc[merge.name.accpt_cc$Decimal.Latitude==39,]

#Institutions with data for mapping, one is Lat 26 something - that's out of colorado!
paste(names(table(merge.name.accpt_cc$institutionCode)),"(",
      table(merge.name.accpt_cc$institutionCode),")",sep="")


bioclims.385 <- lapply(1:385, function(x){
